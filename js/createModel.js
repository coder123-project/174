AFRAME.registerComponent("createmodels", {
  init: async function() {
    ...
    //add the code to map according to barcode
  ...
  createModel: function(model) {
    ...
    //var scene = document.querySelector("a-entity");

    
    //var scene = document.createElement("a-scene");

    
    //var scene = document.querySelector("a-amrker");
    ...
    //var marker = document.documentQuery("a-entity");
    
    //var marker = document.create("a-marker");
